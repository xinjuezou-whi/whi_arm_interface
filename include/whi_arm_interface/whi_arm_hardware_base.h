...
namespace whi_arm_hardware_interface
{
	...
	{
	public:
		enum Hardware { I2C = 0, CAN_BUS, SERIAL, ROSSERIAL, SOCKET, API, HARDWARE_SUM };
		static constexpr const char* hardware[HARDWARE_SUM] = { "i2c", "canbus", "serial", "rosserial", "socket", "api" };
	...
	protected:
		...
		std::unique_ptr<ros::ServiceClient> client_controller_manager_{ nullptr };
